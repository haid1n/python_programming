...
def add(num_1: float, num_2: float) -> float:
	...
	try:	
		...
		print("ValueError : The value for first or second parameter is not a number.")
...
def subtract(num_1: float, num_2: float) -> float:
	...
	try:
		...
		print("ValueError : The value for the first or second parameter is not a number.")
...
def divide(num_1: float, num_2: float) -> float:
	...
	try:
		...
		print("ZeroDivisionError : The value cannot be divided by zero.")
